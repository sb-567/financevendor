    ...
    <script>
        ...
        function categorytable(vendor_id=""){
            var table =  $("#user_list").DataTable({
                ...
                serverSide: true,
                ajax: {
                url: "{{ route('admin.getblogdetaillistdata') }}", // Server-side URL
                data: function (d) {
            ...
            function deleted(items) {
                    swal.fire({
                        title: 'Are you sure?',
                        text: "Are you sure you want to Delete Blog detail ?",
                        type: 'warning',
                            ...
                            //  dataType:'json',
                                ...
                                success: function(data) {
                                    swal.fire({
                                        // position: 'top-right',
                                        type: 'success',
                                        title: 'Blog detail data Deleted Successfully',
            ...
            function deletedchecked() {
                   ...
                   $('input[type="checkbox"].form-check-input:checked').each(function () {
                    ...
                    swal.fire("! Opps ", "Please check Blog detail data to delete", "error");
                    }
            }
