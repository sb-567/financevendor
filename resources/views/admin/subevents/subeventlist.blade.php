        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                    <h4 class="mb-sm-0">Sub Events List</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboards</a></li>
                            <li class="breadcrumb-item active">Sub Events List</li>
                        </ol>
                    </div>
                        ...
                        <table id="subevent_list" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th data-ordering="false">Event Time</th>
                                    <th>Status</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
        ...
        $(document).ready(function() {
            ...
            function categorytable(status=""){
               ...
               var event_id = "{{$event_id}}";
                ...
                var table =  $("#subevent_list").DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                    url: "{{ route('getsubeventlistdata') }}", // Server-side URL
                    data: function (d) {
                    ...
                    columns: [
                        ...
                        { data: 'sub_event_title', name: 'sub_event_title' },
            ...
            $(document).ready(function () {
                $(document).on("change", ".toggle-switch", function () {
                    ...
                    $.ajax({
                        url: "{{ route('subeventstatuschange') }}", // Change to your backend script
                        type: "POST",
            ...
            function deleted(items) {
                swal.fire({
                    title: 'Are you sure?',
                    text: "Are you sure you want to Delete Sub Event List?",
                    type: 'warning',
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: `{{ url('subeventdelete') }}/${items}`, // Dynamically include 'items' in the URL
                            ...
                            success: function(data) {
                                swal.fire({
                                    type: 'success',
                                    title: 'Sub Event Deleted Successfully',
                                });
                            },
                            complete: function() {
                                swal.hideLoading();
         ...
         function deletedcheckeditem(items) {
             swal.fire({
                 title: 'Are you sure?',
                 text: "Are you sure you want to Delete Sub Event?",
                 type: 'warning',
                 showCancelButton: true,
                 confirmButtonText: 'Yes'
             }).then(function(result) {
                 if (result.value) {
                    $.ajaxSetup({
                     ...
                     $.ajax({
                         url: `{{ route('deleteselectedsubevent') }}`,
                         type: 'POST',
                         data:{
                                items: items
                            },
