                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <form method="post" action="{{url('/')}}/statesave"  enctype="multipart/form-data">
                                    @csrf
                                    <div class="row g-3">
                                        <div class="col-lg-6">
                                            <input type="hidden" name="id" value="@if(!empty($fetched->id)){{$fetched->id}}@endif" >
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="firstnamefloatingInput" name="state_title" placeholder="Enter your Task Title" value="@if(!empty($fetched->state_title)){{$fetched->state_title}}@endif" required>
                                                <label for="firstnamefloatingInput">State Title</label>
                                            </div>
                                        </div>
