        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                    <h4 class="mb-sm-0">Event Task List</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboards</a></li>
                            <li class="breadcrumb-item active">Event Task List</li>
                        </ol>
                    </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-ordering="false">
                                                <div class="form-check"><input class="form-check-input fs-15" type="checkbox" id="checkAll" value=""></div>
                                                SR No.
                                            </th>
                                            <th data-ordering="false">Event</th>
                                            {{-- <th data-ordering="false">Sub Event</th> --}}
        ...
        $(document).ready(function() {
            ...
            function categorytable(status=""){
                ...
                var table =  $("#event_list").DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                    url: "{{ route('getusertasklistdata') }}", // Server-side URL
                    data: function (d) {
                    ...
                    columns: [
                        ...
                        { data: 'event_task_title', name: 'event_task_title' },
